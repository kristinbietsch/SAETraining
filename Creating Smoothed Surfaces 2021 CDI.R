...
cl <- read.dbf("C:/Users/KristinBietsch/files/DHS Data/Cote dIvoire/CIGE81FL/CIGE81FL.dbf") 

# Change this folder and file to the name and location of your women's data from DHS.  Make sure to keep the DTA extension
ch <- read_dta("C:/Users/KristinBietsch/files/DHS Data/Cote dIvoire/CIIR81FL.DTA", col_select = any_of(c("v001", "v005", "v313", "v502", "v626a")))
