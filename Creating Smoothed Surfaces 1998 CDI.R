...
cl <- read.dbf("C:/Users/KristinBietsch/files/DHS Data/Cote dIvoire/CIGE3BFL/CIGE3BFL.dbf") 
...
ch <- read_dta("C:/Users/KristinBietsch/files/DHS Data/Cote dIvoire/CIIR3AFL.DTA")
