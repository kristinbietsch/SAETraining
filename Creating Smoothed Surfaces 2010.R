...
cl <- read.dbf("C:/Users/KristinBietsch/Avenir Health Dropbox/Kristin kbietsch@avenirhealth.org/Avenir Track20/Training Materials/Small Area Estimates 2026/Burkina Faso/Data/DHS/BFGE61FL/BFGE61FL.dbf") 

# Change this folder and file to the name and location of your women's data from DHS.  Make sure to keep the DTA extension
ch <- read_dta("C:/Users/KristinBietsch/Avenir Health Dropbox/Kristin kbietsch@avenirhealth.org/Avenir Track20/Training Materials/Small Area Estimates 2026/Burkina Faso/Data/DHS/BFIR62FL.DTA", col_select = any_of(c("v001", "v005", "v313", "v502", "v626a")))
