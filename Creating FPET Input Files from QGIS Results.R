...
setwd("C:/Users/KristinBietsch/Avenir Health Dropbox/Kristin kbietsch@avenirhealth.org/Avenir Track20/Training Materials/Small Area Estimates 2026/Burkina Faso/Data/QGIS Results")
...
results_long1 <- results_long %>% rename(Value=29) %>% mutate(Variable="") %>% filter(Value==100000000)
...
for (row in 1:nrow(filelist)) {
  ...
  varname <- name_list[29]  
  
  data_clean <- data %>% rename(Value=29) %>%
...
write.csv(fpet_survey_data, "C:/Users/KristinBietsch/Avenir Health Dropbox/Kristin kbietsch@avenirhealth.org/Avenir Track20/Training Materials/Small Area Estimates 2026/Burkina Faso/Burkina Faso Adm2 Survey Data.csv", row.names = F, na="")
write.csv(fpet_pop_data, "C:/Users/KristinBietsch/Avenir Health Dropbox/Kristin kbietsch@avenirhealth.org/Avenir Track20/Training Materials/Small Area Estimates 2026/Burkina Faso/Burkina Faso Adm2 Pop Data.csv", row.names = F, na="")