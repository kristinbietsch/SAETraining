...
setwd("C:/Users/KristinBietsch/Avenir Health Dropbox/Kristin kbietsch@avenirhealth.org/Avenir Track20/Training Materials/Small Area Estimates 2026/Burkina Faso/Burkina Faso Adm2_all_data")
...
data <- read.csv("Burkina Faso Adm2-results.csv")
